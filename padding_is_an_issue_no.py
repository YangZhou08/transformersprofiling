...
batch_size = 50 
generated_input_data = torch.randint(low = 0, high = tokenizer.vocab_size, size = (batch_size, 60), dtype = torch.long).to(torch.bfloat16).to(torch_device) 
