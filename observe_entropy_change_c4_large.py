...
for i in range(20): 
    ...
    output_prob_max = output_prob_max * attention_mask.unsqueeze(0) 
    output_prob_max = output_prob_max[0].detach().cpu().numpy() 
    print(output_prob_max) 
    plt.bar(range(len(output_prob_max)), output_prob_max, width = 0.3, color = "orange") 
