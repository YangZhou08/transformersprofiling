...
# done 
CUDA_VISIBLE_DEVICES=1 python bigmodeldatasetgeneration_largegpus.py --kernel_size 7 --model_name tinyllama --path_d $i --batch_size 128 --task_id $SLURM_ARRAY_TASK_ID & 
