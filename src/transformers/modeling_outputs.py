...
@dataclass 
class CausalLMOutputWithPastLargeDistance(ModelOutput): 
    # newly added for customized l2 distance report (on Dec. 27th for outputing L2 distance) 
    """
    Base class for causal language model (or autoregressive) outputs.
...
@dataclass 
class CausalLMOutputWithPastLargeDistance2(ModelOutput): 
    # newly added for customized l2 distance report (on Dec. 27th for outputing L2 distance) 
    """
    Base class for causal language model (or autoregressive) outputs.
...
@dataclass 
class CausalLMOutputWithPastLargeDistance3(ModelOutput):  
    # newly added for customized l2 distance report (on Dec. 27th for outputing L2 distance) 
    """
    Base class for causal language model (or autoregressive) outputs.
