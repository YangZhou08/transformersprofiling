...
d = onedataset.train_test_split(test_size = 0.02)  # 0.995 for training, 0.005 for testing 
...
training_args = TrainingArguments(
    ...
    per_device_train_batch_size = 60, # the training batch size, put it as high as your GPU memory fits
